        ...
        <div className="py-8 md:py-12">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 md:gap-8">
            ...
            >
                  ...
                  {allSocialLinks.slice(0, 7).map((social, index) => {
                    ...
                    return (
                      <motion.a
                        ...
                        whileTap={{ scale: 0.9 }}
                        className={`group relative w-8 h-8 bg-glass backdrop-blur-xl border border-white/10 rounded-lg flex items-center justify-center text-gray-400 transition-all duration-300 hover:border-transparent ${social.color}`}
                      ...
                      >
                        ...
                        {/* Using Icon Components instead of missing images */}
                        <IconComponent className="w-4 h-4 relative z-10 group-hover:scale-110 transition-transform duration-300" />
              ...
              {/* CORRECTED Quick Contact - Fixed typo in px-2 */}
