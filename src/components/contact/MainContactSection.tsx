        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          ...
          >
            ...
            <motion.div
              ...
              viewport={{ once: true }}
              className="bg-glass backdrop-blur-xl border border-primary-500/30 bg-primary-500/5 rounded-2xl p-8 mb-10 relative overflow-hidden"
            >
              ...
              <div className="flex items-center gap-4 mb-6">
                <div className="relative">
                  ...
                  <div className="absolute bottom-0 right-0 w-5 h-5 bg-green-500 border-2 border-bg-secondary rounded-full">
                    <motion.div
                ...
                <div>
                  ...
                  <p className="text-primary-400 font-semibold">Lead Developer & Contact Coordinator</p>
                  <div className="flex items-center gap-1 text-sm text-green-400 mt-1">
                    <div className="w-2 h-2 bg-green-500 rounded-full animate-pulse" />
                    Active now • Responds in ~2 min
                  </div>
                </div>
              </div>

              <p className="text-gray-300 text-sm mb-6 leading-relaxed">
                I personally handle all contact requests and ensure you get the support you need. 
                Whether it's joining our team, technical help, or just a friendly chat - I'm here for you!
              </p>
              ...
              <div className="flex gap-3">
                ...
                <motion.a
                  ...
                  whileHover={{ scale: 1.05, y: -2 }}
                  whileTap={{ scale: 0.95 }}
                  className="flex-1 bg-green-500 text-white py-3 px-4 rounded-lg font-semibold text-center hover:bg-green-600 transition-colors duration-300 flex items-center justify-center gap-2"
                >
