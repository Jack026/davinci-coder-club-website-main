...
const MemberModal = () => {
  // Get modal state from TeamContext
  const { selectedMember, modalOpen, closeModal } = useTeam()
  ...
  // Early return if modal is not open or no member selected
  if (!modalOpen || !selectedMember) return null
        ...
        >
          ...
          <div className={`sticky top-0 bg-gradient-to-r ${departmentGradient} p-6 flex items-center justify-between border-b border-white/10 rounded-t-3xl relative z-10`}>
            ...
            <div className="flex items-center gap-4 relative z-10">
              <div className="w-16 h-16 bg-white/20 rounded-full flex items-center justify-center text-2xl font-bold text-white relative">
